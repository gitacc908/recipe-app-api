...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_delete_ingredient(self):
        ...
        self.assertEqual(len(Ingredient.objects.filter(user=self.user)), 0)

    def test_ingredients_assigned_to_a_recipe(self):
        """Test listing ingredients assigned to a recipe"""
